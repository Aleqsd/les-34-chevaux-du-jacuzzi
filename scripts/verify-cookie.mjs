...
try{
 ...
 check("expanded catalog sizes and unique identifiers",game.UPGRADES.length===270&&game.COOKIE_MISSIONS.length===116&&game.COOKIE_ACHIEVEMENTS.length===183&&["UPGRADES","COOKIE_MISSIONS","COOKIE_ACHIEVEMENTS"].every(k=>new Set(game[k].map(x=>x.id)).size===game[k].length));
