...
export const profiles=sqliteTable("profiles",{authorKey:text("author_key").primaryKey(),author:text("author").notNull(),avatar:integer("avatar").notNull(),imageUrl:text("image_url").notNull().default("")});
