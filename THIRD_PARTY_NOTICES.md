...
- `public/horse.glb` : **Horse** par **Quaternius**, sous [CC0 1.0](https://creativecommons.org/publicdomain/zero/1.0/), via [Poly Pizza](https://poly.pizza/m/qvTrSG9pZF). Le modèle est utilisé dans une scène Three.js avec des matériaux chromés.
- `public/jacuzzi.webp`, `public/escape-game.webp`, `public/karting.webp` , `public/kawaii-avatars.webp`, `public/kawaii-avatars-extra.webp` et `public/kawaii-avatars-more.webp` : illustrations originales générées avec ImageGen. Prompts dans le README et `docs/`. Les illustrations de lieux sont imaginaires.
