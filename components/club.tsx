...
export default function Club() {
  ...
  const vote = (id:string,value:number,slot=false) => identify(async author=>{
    ...
    try{
      ...
      void load();celebrate(value===1?"yes":"no");toast.success(previous?.value===value?"Ton vote est confirmé.":previous?"Changement d’avis enregistré !":value===1?author+" est chaud ! Vote enregistré.":"C’est noté, "+author+". Vote contre enregistré.");
