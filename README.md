...
- Onze cartes holographiques à retourner avec les contributions par prénom. 60 avatars kawaii libres et 79 avatars exclusifs à gagner dans l’Arcade, ou image HTTPS personnalisée. Vestiaire partagé : chapeaux, lunettes, bouée, positions réglables par glissement ou flèches, poignées de redimensionnement de 50 à 180 %, proportions libres ou verrouillées et rotation directe, recentrage, danses au survol et réactions aux votes. Animations désactivables et respect du mouvement réduit.
...
- Cookie Jacuzzi : 56 bâtiments, achats ×1/×10/×100/Max, 270 recettes, 116 objectifs permanents, 6 objectifs de reconstruction par fournée et 183 succès. Filtres de catalogue, gains réels par achat, délais estimés hors bonus et prochain objectif compact. Prestige avec aperçu du gain relatif, repères +10 %/+25 %/+100 %, réserve de départ et primes de reconstruction qui n’augmentent jamais le score ni les étoiles. Les records, succès, avatars, clics et vitesses du pilote restent acquis. Production hors ligne limitée à 8 h ; pilote automatique à 2 000 clics, accéléré à 5 000, 15 000 et 50 000, choix ON/OFF mémorisé par prénom sur l’appareil. Soixante-dix-neuf compagnons gourmands : l’atelier adopte le dernier avatar gagné, entouré de flammes pendant la fournée dorée. Six surprises ponctuelles (cookies, cadeau, comète, pluie, fournée ×7, ticket doré) avec sons et notifications. Mode plein écran, musique originale optionnelle à plusieurs ambiances, prix visibles et sauvegarde discrète. Requêtes idempotentes, reprise des actions en attente et protection contre les récompenses dupliquées entre onglets.
- Maîtrise permanente : neuf talents dans trois branches, 27 points obtenus après 135 succès pour compléter les neuf talents au rang 3, sans points excédentaires ; redistribution gratuite et conservation au prestige. Bâtiments évolutifs à 1/10/25/50/100 exemplaires. Objectifs conseillés et suivi partagé entre appareils. Chargement différé des modes avancés et affichage allégé sur mobile.
- Bureau des fournées : trois contrats renouvelables (production, investissement, chasse), une commande active sans expiration, prime figée et parcours permanent. Trois écoles réversibles à la première étoile : Architecte, Artisan et Veilleur. Sceaux cosmétiques, cadres de compagnon et huit succès de carrière. [Règles et équilibre](docs/GAMEPLAY.md).
- Premiers horizons : deux chapitres avancés, six bâtiments cosmiques et trente recettes, dont douze synergies avec les anciens ateliers. Accès historiques jusqu’à 10²⁶, objectifs jusqu’à 10²⁸. Trois épreuves de maître dans un atelier séparé, médailles, meilleurs temps et décors permanents. Chaque réussite réclamée double les fours, les clics et le pilote pendant une heure réelle ; rejouer renouvelle 60 minutes sans les additionner. Le bonus se combine aux événements et survit au prestige, sans gonfler les objectifs ni les estimations hors bonus. Quatre chantiers collectifs de trois étapes (Jacuzzi, Observatoire, Jardin, Hippodrome), quatre contributions distinctes par étape. Chaque projet débloque un décor pour tous et un monument au QG ; aperçu des récompenses et galerie permanente. Les indices des contributions existantes sont conservés. Clics manuels limités côté serveur à 12/s soutenus avec une tolérance de 24 clics pour le réseau ; pilote indépendant.
- Multivers : la progression continue après 10³⁰ avec onze nouveaux bâtiments, cinquante-cinq recettes, vingt-deux objectifs et vingt-six succès. Trois chapitres mènent au Banquet des origines à 10⁶⁰. Les extensions Aube, Jubilé et Voyages poursuivent le parcours jusqu’au dernier bâtiment à 10¹⁴⁷. À la fin officielle de 10¹⁵³, un pégase légendaire rejoint le vestiaire et un bouton ouvre une demande de contenu préremplie sur GitHub. Anciens acquis et rendements conservés. Voir [la progression avancée](docs/MULTIVERSE.md).
- Rythme du jacuzzi : quatre pistes originales de 90 à 174 BPM, 64 cercles chacune, entraînement ralenti, records et combos par piste. Réussir un défi accorde +25 % de production et de rendement des clics pendant 24 heures, sans cumul. [Règles des pistes](docs/RHYTHM.md).
...
La playlist originale contient Biscuit cosmique, Caramel disco, Jacuzzi néon et Goûter tropical. Elle change après quatre boucles de 16 mesures, soit toutes les 2 à 2 min 15 selon le tempo. Le morceau en cours est affiché ; une pause fige la rotation. Le lecteur propose trois sets : Super dynamique (quatre nouveaux titres de 148 à 174 BPM avec enchaînement automatique ou morceau au choix), Calme (Salon des étoiles, Veille de l’observatoire et Jardin de caramel) et Radio du Jacuzzi (les quatre titres originaux). Le set Super dynamique est proposé par défaut. Piste et volume sont mémorisés localement ; la musique se met aussi en pause pendant le défi rythmique. La musique reste désactivée par défaut ; changer d’onglet la met en pause et la reprise se fait au bouton.
