...
- Onze cartes holographiques à retourner avec les contributions par prénom. 60 avatars kawaii libres et 78 avatars exclusifs à gagner dans l’Arcade, ou image HTTPS personnalisée. Vestiaire partagé : chapeaux, lunettes, bouée, positions réglables par glissement ou flèches, poignées de redimensionnement de 50 à 180 %, proportions libres ou verrouillées et rotation directe, recentrage, danses au survol et réactions aux votes. Animations désactivables et respect du mouvement réduit.
...
- Cookie Jacuzzi : 47 bâtiments, achats ×1/×10/×100/Max, 225 recettes, 98 objectifs permanents, 6 objectifs de reconstruction par fournée et 162 succès. Filtres de catalogue, gains réels par achat, délais estimés hors bonus et prochain objectif compact. Prestige avec aperçu du gain relatif, repères +10 %/+25 %/+100 %, réserve de départ et primes de reconstruction qui n’augmentent jamais le score ni les étoiles. Les records, succès, avatars, clics et vitesses du pilote restent acquis. Production hors ligne limitée à 8 h ; pilote automatique à 2 000 clics, accéléré à 5 000, 15 000 et 50 000, choix ON/OFF mémorisé par prénom sur l’appareil. Soixante-dix-huit compagnons gourmands : l’atelier adopte le dernier avatar gagné, entouré de flammes pendant la fournée dorée. Six surprises ponctuelles (cookies, cadeau, comète, pluie, fournée ×7, ticket doré) avec sons et notifications. Mode plein écran, musique originale optionnelle à plusieurs ambiances, prix visibles et sauvegarde discrète. Requêtes idempotentes, reprise des actions en attente et protection contre les récompenses dupliquées entre onglets.
- Maîtrise permanente : neuf talents dans trois branches, points issus des succès, redistribution gratuite et conservation au prestige. Bâtiments évolutifs à 1/10/25/50/100 exemplaires. Objectifs conseillés et suivi partagé entre appareils. Chargement différé des modes avancés et affichage allégé sur mobile.
